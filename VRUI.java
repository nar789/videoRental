...
public class VRUI {
	...
	public void clearRentals() {
		...
		Customer foundCustomer = vrController.foundCustomer(customerName);

		if ( foundCustomer == null ) {
			System.out.println("No customer found") ;
		} else {
			displayCustomerSummary(foundCustomer);

			vrController.clearRentals(foundCustomer);
		}
	}
	...
	public void returnVideo() {
		...
		vrController.returnVideo(foundCustomer, videoTitle);
	}
